...
class Options(object):
	def __init__(self,args,parser,default_resolve_path,default_symlinks_path,supported_git_protocols):
		...
		self.known_args={}
		self.unknown_args=[]
		self.parser.add_argument('--resolve_path',default=default_resolve_path,dest='--resolve_path',help="The folder where the resolved dependencies are downloaded. ""[default: '{}']".format(default_resolve_path))
		self.parser.add_argument('--git_protocol',dest='--git_protocol',help='Use a specific git protocol to download dependencies. ''Supported protocols: {}'.format(supported_git_protocols))
		self.parser.add_argument('--symlinks_path',default=default_symlinks_path,dest='--symlinks_path',help="The folder where the dependency symlinks are placed. ""[default: '{}']".format(default_symlinks_path))
